...
export function JournalCard({journal}: JournalProps) {
    return (
        <a href='/journal/view-journal'><button className="bg-gray-100 p-4 rounded-lg shadow-md mb-5 mx-2 w-56 sm:w-auto focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50">
